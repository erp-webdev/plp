...
Route::group(['prefix' => '/', 'middleware' => ['auth']], function(){
	...
	Route::get('loans/deduction/upload', ['as' => 'loan.deduction.show', 'uses' => 'admin\LoanController@showDeduction', 'middleware' => ['permission:custodian']]);
	...
	Route::post('loans/officer/notifs', ['as' => 'loan.officer.notif', 'uses' => 'admin\LoanController@sendOfficerList', 'middleware' => ['permission:custodian']]);
	Route::get('loans/officer/list', ['as' => 'loan.officer.list', 'uses' => 'admin\LoanController@getFormattedOfficerList', 'middleware' => ['permission:custodian']]);
	...
	Route::post('applications/cancel/{id}',['as'=>'applications.cancel','uses'=>'admin\ApplicationController@cancel','middleware' => ['permission:application_delete']]);
	...
	Route::post('treasury/transmittal/send', ['as' => 'treasury.transmittals.send', 'uses' => 'admin\TreasuryController@sendTransmittal', 'middleware' => ['permission:treasurer']]);
...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::post('preferences/special',['as'=>'preferences.terms','uses'=>'admin\PreferenceController@updateSpecialTerms', 'middleware' => ['permission:Preferences']]);
