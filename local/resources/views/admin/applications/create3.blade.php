        ...
        <div class="col-md-6 col-sm-6"> 
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        @if(isset($loan->id))
                        <td colspan="2" class=""><button type="submit" name="submit" class="btn btn-primary pull-right btnSave" data-title="Submit Application!" data-content="Are you sure you want to submit application?"  data-form="#loanform">Submit</button></td>
                        @else
