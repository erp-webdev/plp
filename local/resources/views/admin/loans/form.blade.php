...
<head>
    ...
    <title>Personal Load Program {{ $loan->ctrl_no }}</title>
    <style>
        *, *::before, *::after {
        ...
        /* Newly added "input-center, center" */
        .container input[type='text'].input-center {
            text-align: center;
        }
        .container center {
            text-align: center;
        ...
        .container form > div + div {
            ...
            .applicant-details {
                ...
                .form-header {
                    ...
                    .type-of-app .nurse-signature {
                        width: 60%;
                        height: 20px;
                        /* remove these properties background-color & border-top */
                        position: absolute;
                        /* bottom: 0 -> 20px */
                        bottom: 20px;
                        right: 0;
                    }
                    .type-of-app .nurse-signature input {
                            width: 100%;
                            font-size: 12px;
                    ...
                    .form-header .type-of-loan {
                        ...
                        /* New added property "line-height: 20px" */
                        .date-of-loan label {
                            display: block;
                            font-size: 11px;
                            line-height: 20px;
                ...
                .applicant-signature-1 > div {
                    ...
                    .requester-sign span.signature-wrapper,
                    .endorser-sign span.signature-wrapper {
                        display: block;
                        width: 300px;
                        min-height: 20px;
                        position: absolute;
                    ...
                    /* If uppercase, add text-transform property. "text-transform: uppercase;" */
            ...
            .action-taken {
                ...
                .action-taken div .approval-wrapper {
                    ...
                    .approval-wrapper .approval-row {
                        ...
                        .approval-row span input[type='checkbox'] {
                            width: 30px;
                            transform: scale(1.8);
                            border-radius: 0;
                            position: absolute;
            ...
            .certification {
                ...
                .certification .printed-by-and-date {
                    position: absolute;
                    bottom: 3px;
                    left: 3px;
                }
                    .printed-by-and-date label {
                        font-size: 10px;
                    }
                    .printed-by-and-date label input[type='text'] {
                        font-size: 10px;
                        border: 0;
                    }
    </style>
    ...
    <div class="container">
        <form action="url_or_some_php_file.php" method="post">
                ...
                <div class="form-header">
                    <div class="type-of-app">
                        ...
                        <div class="type-app-table">
                            <div class="type-app-table-row">
                                <div class="type-app-table-cell app-type-reg">
                                    <!-- New class for input field : "input-center" -->
                                    <label><input class="application-type input-center" type="text" value="{{ $loan->type == 0 ? '✓' : '' }}">NEW</label>
                                </div>
                                <div class="type-app-table-cell re-evailment">
                                    <!-- New class for input field : "input-center" -->
                                    <label><input class="application-type input-center" type="text" value="{{ $loan->special == 0 ? '': '✓' }}">RE-AVAILMENT</label>
                                    <ul>
                                        <li><label>Previous loan amount:</label><input type="text"></li>
                            ...
                            <div class="type-app-table-row">
                                <div class="type-app-table-cell app-type-reg">
                                    <!-- New class for input field : "input-center" -->
                                    <label><input class="application-type input-center" type="text" value="{{ $loan->special == 0 ? '✓': '' }}">REGULAR</label>
                                </div>
                                <div class="type-app-table-cell app-type-special">
                                    <!-- New class for input field : "input-center" -->
                                    <label><input class="application-type input-center" type="text" value="{{ $loan->special == 0 ? '': '✓' }}">SPECIAL</label>
                                    <p>Validated by:</p>
                                </div>
                            </div>
                        </div>
                        <div class="nurse-signature">
                            <!-- input field added -->
                            <input class="input-center" type="text" value=" {{ $loan->company_nurse }} - {{ $loan->company_nurse_date }}">
                ...
                <div class="applicant-signature-1">
                    ...
                    <div class="requester-sign">
                        ...
                        <span class="signature-wrapper">
                            <input class="input-center" id="requester-sign-field" type="text" value="{{ $loan->FullName }}">
                    ...
                    <div class="endorser-sign">
                        ...
                        <span class="signature-wrapper">
                            <input class="input-center" id="endorser-sign-field" type="text" value="{{$loan->endorser_FullName}}">
                            <!-- sign-label and p is center -->
            ...
            <div class="surety">
				...
				<p class="statement">
					I hereby consent to act as surety of the applicant and agree to pay the abovenamed applicant's loan up to the amount of PHP <input class="input-center" type="text" value="{{ $utils->formatNumber($loan->guaranteed_amount) }}"><br>
                ...
                <div>
                    ...
                    <input type="text" class="input-center" value="{{ $loan->guarantor_FullName }}">
            ...
            <div class="custodian">
                ...
                <br>
                <input class="total-php" value="Total Php " placeholder="Total Php">
