...
<form id="TreasuryForm" class="form-horizontal table-responsive" style="font-size: 12px" action="{{ route('treasury.approve') }}" method="post" ng-app="ApprovalApp" ng-controller="ApprovalCtrl">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8">
                    ...
                    <div class="input-group">
                      ...
                      <div class="input-group-btn">
                        <button type="submit" name="save_checkno" class="btn btn-primary btnSave" data-title="Update Check No" data-content="Are you sure you want to update the check number?" data-form="#TreasuryForm"  title="Update check no."><i class="fa fa-save"></i></button>
                      </div>
                    </div>
                    @else
                 ...
                 <!--  <div class="col-xs-12 col-sm-6 col-md-6">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                      ...
                      <input name="check_released" type="date" id="datep" class="datepicker-range form-control input-sm " placeholder="mm/dd/yyyy" required>
                    </div>
                  </div>
                @else
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="submit" name="save_checkdate" class="btn btn-primary btnSave" data-title="Update Check Date" data-content="Are you sure you want to update the check date?" data-form="#TreasuryForm" title="Update check date"><i class="fa fa-save"></i></button>
                        </div>
                      </div>
                      @else
  ...
  <div class="modal-footer">
    ...
    <div class="input-group">
        ...
        <div class="input-group-btn">
                <button type="submit" name="release" class="btn btn-success btnSave" data-title="Confirm Release of Check" data-content="You are about to release the check of the loan application of {{ utf8_encode($loan->FullName) }}." data-form="#TreasuryForm" data-validate="validate_standard"><i class="fa fa-send"></i> Release Check</button>
        </div>
    </div>
    <br>
    @endif
